...
radius = 0.06 # the S in loss, not the grasp region radius
...
if args.eval_diffwidth:
    ...
    if args.eval_width in ['0.06', '0.08', '0.10', '0.12']:
        test_dataset_path = os.path.join(args.data_path, args.eval_width)
    else:
        test_dataset_path = os.path.join(args.data_path, '0.08') # coverage is not accurate
