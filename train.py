...
parser.add_argument('--eval-width', type=float, default=0.10)
...
test_score_loader  = utils.get_dataloader(test_score_dataset, args.batch_size, shuffle=False)#None#
...
class RegionModule():
    def __init__(self, start_epoch=0, end_epoch=1, train_data_loader=None, 
        ...
        if "test" in args.mode and args.eval_diffwidth:
